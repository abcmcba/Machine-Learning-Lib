...
from predict_subclass import predictor
...
def train(instances, algorithm, online_training_iterations, online_learning_rate):
    # TODO Train the model using "algorithm" on "data"
    # TODO This is where you will add new algorithms that will subclass Predictor
    predict = predictor(algorithm, online_training_iterations, online_learning_rate)     
...
def main():
    ...
    if args.mode.lower() == "train":
        ...
        # Train the model.
        predictor = train(instances, args.algorithm, args.online_training_iterations, args.online_learning_rate)     # add two parameters here
        try:
